...
describe('calculationService', () => {
  ...
  describe('calculateTotalExpenses', () => {
    it('should calculate total expenses from transactions', () => {
      const result = calculationService.calculateTotalExpenses(mockTransactions);
  ...
  describe('calculateCategoryBreakdown', () => {
    it('should calculate breakdown for expense transactions', () => {
      const result = calculationService.calculateCategoryBreakdown(mockTransactions, 'expense');
    ...
    it('should calculate breakdown for income transactions', () => {
      const result = calculationService.calculateCategoryBreakdown(mockTransactions, 'income');
    ...
    it('should calculate breakdown for all transactions', () => {
      const result = calculationService.calculateCategoryBreakdown(mockTransactions, 'all');
    ...
    it('should return empty array when no transactions', () => {
      const result = calculationService.calculateCategoryBreakdown([], 'expense');
  ...
  describe('calculateDashboardSummary', () => {
    it('should calculate complete dashboard summary for a period', () => {
      const result = calculationService.calculateDashboardSummary(mockTransactions, {
        type: 'month',
    ...
    it('should filter transactions by date range', () => {
      ...
      const result = calculationService.calculateDashboardSummary(transactions, {
        type: 'month',
  ...
  describe('getDateRangeForPeriod', () => {
    it('should return single day for "day" type', () => {
      const result = calculationService.getDateRangeForPeriod('day', '2026-02-15');
    ...
    it('should return Monday-Sunday for "week" type', () => {
      const result = calculationService.getDateRangeForPeriod('week', '2026-02-05'); // Thursday
    ...
    it('should return full month for "month" type', () => {
      const result = calculationService.getDateRangeForPeriod('month', '2026-02-15');
    ...
    it('should handle leap year February', () => {
      const result = calculationService.getDateRangeForPeriod('month', '2024-02-15');
    ...
    it('should handle Date objects', () => {
      const result = calculationService.getDateRangeForPeriod('day', new Date('2026-02-15'));
    ...
    it('should handle 31-day months', () => {
      const result = calculationService.getDateRangeForPeriod('month', '2026-01-15');
    ...
    it('should handle 30-day months', () => {
      const result = calculationService.getDateRangeForPeriod('month', '2026-04-15');
